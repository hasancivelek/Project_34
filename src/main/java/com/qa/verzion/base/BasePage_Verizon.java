...
public class BasePage_Verizon {
	...
	public Properties init_properties() {
		prop=new Properties();
		String path="/Users/mrs.z./Desktop/HasanNew/Verizon/src/main/java/com/qa/verzion/config/config.properties";
